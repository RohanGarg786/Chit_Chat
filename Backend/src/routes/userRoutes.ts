...
import { registerUserController ,loginUserController, userDetailsController, addNewContact, allContacts, allMessages, deleteContact, checkAuthentication, deleteMessage } from '../controller/registerController';
...
userRouter.delete('/deleteMessage/:messageId', deleteMessage)
